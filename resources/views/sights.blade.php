        ...
        <div class="row">
            <div class="col offset-xl-1">
                <ul class="breadcrumbs__ul row">
                    ...
                    <li class="breadcrumbs__li col-auto breadcrumbs__li_active"><span>Достопримечательности</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="filers__all filers-place-map">
    <div class="place-map d-lg-block d-none">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 offset-xl-1">
                <div class="filter__block">
                    <h5 class="title-h5 filter__block-title">фильтр Достопримечательностей</h5>
                    ...
                    <div class="row">
                        <div class="filter__block-setting col-lg-12 col-12">
                        ...
                        <div class="filter__block-setting col-lg-12 col-6">
                            ...
                            <div class="setting__buttons">
                                <div class="buttons__item">
                                    ...
                                    <label for="ch7">Архитектурные</label>
                                </div>
                                <div class="buttons__item buttons__item_more">
                                    <!-- <input id="ch7" type="checkbox"> -->
                                    <label for="ch7">Еще</label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="place-map d-lg-none d-block">
                <img src="image/map.jpg" alt="">
            </div>
            <div class="col-lg-8">
                <h4 class="title-h4 title-filter">Найдено: 3 места</h4>
                <div class="block__finder row">
                    <div class="col-md-12">
                        <div class="block__item">
                            <div class="row">
                                <div class="photo col-auto">
                                    <img src="image/photo29.jpg" alt="">
                                </div>
                                <div class="bottom__text col">
                                    <h4 class="title-h4">Заповедник “Мария”</h4>
                                    <div class="bottom__block row">
                                        <h5 class="title-h5 col-auto">Район:</h5>
                                        <p class="text-p col-auto">Пряжинский</p>
                                    </div>
                                    <div class="bottom__block row">
                                        <h5 class="title-h5 col-auto">Город:</h5>
                                        <p class="text-p col-auto">Пряжин</p>
                                    </div>
                                    <p class="text-p">Один из старейших заповедников России, создан 11 июня 1931 года при Академии наук СССР для охраны природы русского севера...</p>
                ...
                <div class="center__block">
                    <div class="row justify-content-between">
                        <div class="col-lg col-12 center__ul">
                            ...
                            <p class="text-p p-pos-abs">Заповедник “Мария” - государственный природный заповедник, центральным объектом которого является одноимённый водопад.</p>
                        </div>
                        <div class="col-lg-5 col-12">
                            <div class="photo">
                                <img src="image/photo38.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <p class="text-p">
                    Один из старейших заповедников России, создан 11 июня 1931 года при Академии наук СССР для охраныприроды русского севера и решения практических задач хозяйствования. Начиная с послевоенного времении до сих пор, заповедник выполняет не только природоохранные, но и научно-исследовательские и эколого-просветительские задачи. Здесь постоянно ведутся работы по изучению природных комплексов Карелии. Занимает площадь 10 930 га. Вокруг заповедника создана охранная зона общей площадью 6 213 га.
                </p>
                <h2 class="title-h2 text-center">Видео с заповедника</h2>
                <div class="photo">
