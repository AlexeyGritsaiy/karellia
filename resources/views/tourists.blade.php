        ...
        <div class="row">
            <div class="col offset-xl-1">
                <ul class="breadcrumbs__ul row">
                    ...
                    <li class="breadcrumbs__li col-auto breadcrumbs__li_active"><span>Туры</span></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg col-12 offset-xl-1">
                <h2 class="title-h2">Туроператоры</h2>
            </div>
...
<section class="filers__all filers-tours">
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-lg-4 offset-xl-1">
                <div class="filter__block">
                    <h5 class="title-h5 filter__block-title">Туроператоров: 169</h5>
                    ...
                    <div class="row">
                        <div class="filter__block-setting col-lg-12 col-12">
                            <h5 class="title-h5">Ваша локация:</h5>
                            <p class="text-p">Неправильно определена локация?</p>
                        </div>
                        <div class="filter__block-settings col-lg-12 col-12 select__block">
            ...
            <div class="col-lg-8">
                <h4 class="title-h4 title-filter">Найдено: 3 туроператора</h4>
                <div class="block__finder">
                    <div class="block__item">
                        <div class="row">
                            ...
                            <div class="col">
                                <h4 class="title-h4">Туроператор Anex Tour</h4>
                                <p class="text-p">
                                    Туроператор с 20-летним опытом организации туров по Скандинавии и Прибалтики. Регулярные экскурсионные туры на автобусах, паромах, поездах в Финляндию  от 2 дней. Индивидуальные туры на любой вкус. Продажа билетов на поезда, паромы по Скандинавии и Прибалтике. Бронирование любого размещения: отели, коттеджи, СПА отели, усадьбы, горнолыжные курорты, рыбацкие домики
                                </p>
                                <a href="#" data-popup="tour" class="button-a button-a_v2 d-block">
                                    Посмотреть
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="block__item">
                        <div class="row">
                            <div class="col-lg-3 mb-4">
                                <div class="photo">
                                    <img src="image/coral.png" alt="">
                                </div>
                            </div>
                            <div class="col">
                                <h4 class="title-h4">Туроператор Coral Travel</h4>
                                <p class="text-p">
                                    Туроператор с 20-летним опытом организации туров по Скандинавии и Прибалтики. Регулярные экскурсионные туры на автобусах, паромах, поездах в Финляндию  от 2 дней. Индивидуальные туры на любой вкус. Продажа билетов на поезда, паромы по Скандинавии и Прибалтике. Бронирование любого размещения: отели, коттеджи, СПА отели, усадьбы, горнолыжные курорты, рыбацкие домики
                                </p>
                                <a href="#" class="button-a button-a_v2 d-block">
                                    Посмотреть
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="block__item">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="photo">
                                    <img src="image/joinup.png" alt="">
                                </div>
                            </div>
                            <div class="col">
                                <h4 class="title-h4">Туроператор Join Up</h4>
                                <p class="text-p">
                                    Туроператор с 20-летним опытом организации туров по Скандинавии и Прибалтики. Регулярные экскурсионные туры на автобусах, паромах, поездах в Финляндию  от 2 дней. Индивидуальные туры на любой вкус. Продажа билетов на поезда, паромы по Скандинавии и Прибалтике. Бронирование любого размещения: отели, коттеджи, СПА отели, усадьбы, горнолыжные курорты, рыбацкие домики
                                </p>
                                <a href="#" class="button-a button-a_v2 d-block">
    ...
    <div class="popup popup-tour">
        ...
        <div class="container">
            <div class="popup__inner">
                <div class="row">
                    <div class="col-xl-2 d-lg-block d-none col-3">
                        <div class="photo">
                            <img src="image/anex.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-7 col">
                        <div class="row">
                            <h3 class="col-lg-12 col-auto title-h3">Туроператор Anex Tour</h3>
                            <div class="photo photo-tour d-lg-none d-block col-8 ml-auto">
                                <img src="image/anex.png" alt="">
                            </div>
                        </div>
                        <ul class="mob-ul_social d-lg-none d-block text-left ml-auto banner__socials">
                            <li>
                                <a href="#">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="40" height="40" rx="20" fill="#1977F3"/>
                        ...
                        <div class="row">
                            <div class="col-auto mb-xl-0 mb-3">
                                <a href="#" class="button-a d-block">Оставить заявку на тур</a>
                            </div>
                            <div class="col-auto">
                                <a href="#" class="button-a button-a_v2 d-block">Оставить заявку на тур</a>
                            </div>
                        </div>
                    </div>
                    <ul class="col-auto d-lg-block d-none ml-auto banner__socials">
                        <li>
                            <a href="#">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="40" height="40" rx="20" fill="#1977F3"/>
