        ...
        <div class="row">
            <div class="col offset-xl-1">
                <ul class="breadcrumbs__ul row">
                    ...
                    <li class="breadcrumbs__li col-auto breadcrumbs__li_active"><span>Мероприятия</span></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg col-12 offset-xl-1">
                <h2 class="title-h2">Мероприятия</h2>
            </div>
...
<section class="filers__all filers-cafe filers-calendar">
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-lg-4 offset-xl-1">
                <div class="filter__block">
                    <h5 class="title-h5 filter__block-title">Фильтр мероприятий</h5>
                    ...
                    <div class="row">
                        <div class="filter__block-setting col-lg-12 col-6">
                            <h5 class="title-h5">Вид мероприятия:</h5>
                        ...
                        <div class="filter__block-setting col-lg-12 col-6">
                            <h5 class="title-h5">Выбор даты:</h5>
                        ...
                        <div class="filter__block-setting col-lg-12 col-6">
                            <h5 class="title-h5">Место проведения:</h5>
                            <div class="filter__block-settings select__block">
                                <div class="select">
                                    <div class="select__head">
                                        Карелия
            ...
            <div class="col-lg-8">
                <h4 class="title-h4 title-filter">Найдено: 4 мероприятия</h4>
                    ...
                    <div class="col-md-6">
                        <div class="block__item">
                            ...
                            <div class="bottom__text">
                                ...
                                <a href="#" data-popup="calendar" class="button-a button-a_v2">Посмотреть</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
